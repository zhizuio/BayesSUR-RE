...
sim.ssur <- function(n, s, p, t0=0, seed=123, mv=TRUE){
  ...
  sd_b = 1
  mu_b = 1
  b = matrix(rnorm((p+1)*s,mu_b,sd_b),p+1,s)
  #b = matrix(runif((p+1)*s,-2,2),p+1,s)
  ...
  gamma[1,] = TRUE
  gamma[2:6, 1:5] = TRUE
  gamma[11:21, 6:12] = TRUE
  gamma[31:51, 1:5] = TRUE
  gamma[31:51, 13:20] = TRUE
  gamma[52:61, 1:12] = TRUE
  gamma[71:91, 6:20] = TRUE
  gamma[111:121, 1:20] = TRUE
  ...
  return( list(y=y, x=x, b=b, gamma=gamma, z=z, Gy=G, mrfG=combnAll) )
